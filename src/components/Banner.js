...
const contractAbi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "newLooksrare", type: "address" },
    ],
    name: "setLooksrare",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "address", name: "newOpensea", type: "address" }],
    name: "setOpensea",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newSaleState", type: "uint256" },
    ],
    name: "setSaleState",
    outputs: [],
    stateMutability: "nonpayable",
